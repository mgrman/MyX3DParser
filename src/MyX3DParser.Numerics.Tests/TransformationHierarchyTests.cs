  ...
  <Scene>
    ...
    <Transform>
        <Shape USE='shape'/>
            ...
            Assert.Collection(shape.MyPositions, o => Assert.Equal(new Shared.SceneNodeData(Matrix4x4.Identity, true), o), o => Assert.Equal(new Shared.SceneNodeData(Matrix4x4.Identity, true), o));
        }
  ...
  <Scene>
    <Switch whichChoice='-1'>
        <Shape DEF='shape'/>
            ...
            Assert.Collection(shape.MyPositions, o => Assert.Equal(new Shared.SceneNodeData(Matrix4x4.Identity, false), o));
        }
