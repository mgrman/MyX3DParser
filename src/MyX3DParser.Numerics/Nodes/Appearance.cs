...
namespace MyX3DParser.Generated.Model.Nodes
{
    public partial class Appearance
    {
        ...
        partial void Initialize()
        {
            ...
            var diffuse = new Generated.Model.DataTypes.ColorRGBA(materialNode.diffuseColor.Value.R, materialNode.diffuseColor.Value.G,materialNode.diffuseColor.Value.B,1f - materialNode.transparency.Value);
