...
namespace MyX3DParser.Generated.Model.DataTypes
{
    ...
    {
        public static UnityEngine.Vector3 Parse(string value) => Vec3f.Parse(value);
        public static UnityEngine.Vector3 Parse(IEnumerable<string> value) => Vec3f.Parse(value);

        public static string ToX3DString(UnityEngine.Vector3 value) => Vec3f.ToX3DString(value);
    }
}