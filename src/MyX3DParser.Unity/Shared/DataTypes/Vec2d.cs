...
namespace MyX3DParser.Generated.Model.DataTypes
{
    ...
    {
        public static UnityEngine.Vector2 Parse(string value) => Vec2f.Parse(value);
        public static UnityEngine.Vector2 Parse(IEnumerable<string> value) => Vec2f.Parse(value);

        public static string ToX3DString(UnityEngine.Vector2 value) => Vec2f.ToX3DString(value);
    }
}