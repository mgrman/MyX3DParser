...
namespace MyX3DParser.Generated.Model.DataTypes
{
    ...
    {
        public static UnityEngine.Matrix4x4 Parse(string value) => Matrix3f.Parse(value);
        public static UnityEngine.Matrix4x4 Parse(IEnumerable<string> value) => Matrix3f.Parse(value);
