...
namespace MyX3DParser.Generated.Model.DataTypes
{
    ...
    {
        public static UnityEngine.Vector4 Parse(string value) => Vec4d.Parse(value);
        public static UnityEngine.Vector4 Parse(IEnumerable<string> value) => Vec4d.Parse(value);

        public static string ToX3DString(UnityEngine.Vector4 value) => Vec4d.ToX3DString(value);
    }
}